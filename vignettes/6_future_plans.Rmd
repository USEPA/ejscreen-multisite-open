...
Ultimately, EJScreen features based on EJAM (or a version of EJAM) will be made available to the public. EJAM itself will initially be tested and used within EPA, just as EJScreen was launched internally in 2012 and went public in 2015. A public version would have to be carefully designed to balance user-friendliness of the visual interface and features, relevance to what the public would find useful, and support that includes appropriate documentation and user support.
