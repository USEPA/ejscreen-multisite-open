...
Ultimately, a version of EJAM will be made available to the public, but it will initially be tested and used within EPA, just as EJScreen was launched internally in 2012 and went public in 2015. A public version will have to be carefully designed to balance user-friendliness, relevance to what the public would find useful, and support that includes appropriate documentation and user support. During 2024, EJAM will be tested and launch internally within EPA, as we explore what works and what is still needed, including some of the ideas and plans listed below.
...
To provide further flexibility and help avoid duplication of effort, an EJAM API is planned, and will provide access to services such as fast buffering, summarization, or data.
