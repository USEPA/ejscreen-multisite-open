...
## EPA's Environmental Justice Analysis Multi-site (EJAM) tool

EJAM is a user-friendly web app, developed by the
...
The web app lets you quickly check a summary report, 
...
so EJAM 2.2 uses the same basic data as EJScreen 2.2.
The 2.2 version of EJScreen (released July 2023, with some revisions in late 2023)
had up-to-date demographic data
(e.g., Census 2020 block weights and ACS 2017-2021 block group demographics).
...
For circular buffers, EJAM 2.2 uses the locations of internal points of Census 2020 blocks,
