...
EJAM is a toolkit that will be powering the new "multi-site" features in [EJScreen](https://www.epa.gov/ejscreen "https://www.epa.gov/ejscreen"){.uri target="_blank" rel="noreferrer noopener"}
...
so EJScreen 2.32 (the updated version released in August 2024) and EJAM 2.32 use the same data.
Version 2.32 has ACS 2018-2022 block group demographics and Census 2020 block weights.
