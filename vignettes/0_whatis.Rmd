...
EJAM will be powering new "multi-site" features in [EJScreen](https://www.epa.gov/ejscreen "https://www.epa.gov/ejscreen"){.uri target="_blank" rel="noreferrer noopener"}, and is a new toolkit developed by the United States Environmental Protection Agency (US EPA). It will be available through EJScreen and also as an open-source software package for developers and analysts.
