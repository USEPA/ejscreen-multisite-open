---
title: "1. Installing the EJAM R package"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{1. Installing the EJAM R package}
...
(which will download and build from source, automatically):
