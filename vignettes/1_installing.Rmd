...
There is now no other EJAM-specific package that EJAM needs - all of the code is consolidated in the EJAM package.

The package is available on the [USEPA github](https://github.com/USEPA/EJAM "github.com/USEPA/EJAM"){.uri target="_blank" rel="noreferrer noopener"} (not CRAN)
