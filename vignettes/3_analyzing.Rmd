...
-   Key Functions `ejamit()`, `ejam2report()`, `ejam2excel()`, `ejam2map()`, `ejam2ratios()`
...
```{r plot_count_of_blocks_nearby, eval=FALSE, fig.height=5, fig.width=6}
...
```{r histoblocks, eval = FALSE, fig.height=6, fig.width=7}
...
```{r s2b_stats, eval = FALSE, fig.height=5, fig.width=5}
...
```{r s2b_stats_more, eval = FALSE, fig.height=5, fig.width=5}
