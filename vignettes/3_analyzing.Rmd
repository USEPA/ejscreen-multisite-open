...
See shapefile_from_any() and shapefile_from_folder() and related functions.
...
```{r count_sites_with_n_high, eval=TRUE, echo = FALSE}
...
```{r count_sites_etc_more, eval=TRUE, echo=FALSE}
dimnames(findings)
findings$text[2]
...
```{r plot_count_of_blocks_nearby, eval=TRUE, fig.height=6, fig.width=6}
