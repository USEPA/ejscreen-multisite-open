---
title: "Basics of Using EJAM for Analysis in RStudio"
description: "3. Basics of Using EJAM for Analysis in RStudio"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Basics of Using EJAM for Analysis in RStudio}
...
-   `get_blockpoints_in_shape()` does the same for polygons, finding blocks in each. 
...
The [EJAM package reference manual](https://usepa.github.io/EJAM/reference/index.html) has a complete list of documented functions, grouped by category. There are several categories of functions listed there:

-   Key Functions `ejamit()`, `ejam2report()`, `ejam2excel()`, `ejam2map()`, `ejam2ratios()`, `ejam2table_tall()`
...
-   Test Data (if EJAM is installed, try `browseURL(system.file("testdata", package = "EJAM"))`)
