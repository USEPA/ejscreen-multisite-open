...
#
# data("blockwts") # not needed - it should lazy load as needed from EJAMblockdata::blockwts
```
...
```{r}
  ...
  CountCPU <- parallel::detectCores() # not sure this is used right now
```
