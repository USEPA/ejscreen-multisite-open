...
See the package documentation for a list of functions and what each does. Try ?EJAM for example.
...
-   and ejscreen... in general

Important groups of functions include:

-   distance...

-   ejscreen... such as ejscreenit()

-   fips2... and fips\_...

-   fix... such as fixcolnames()

-   frs\_... such as frs_from\_...

-   getblocks... such as getblocksnearby(), getblocksnearby_from_fips(), get_blockpoints_in_shape(), getblocks_diagnostics()

-   latlon_from\_... such as latlon_from_regid(), latlon_from_naics(), etc.

-   latlon... such as latlon_df_clean() and latlon_is.valid()

-   mapfast... and map\_... such as mapfast(), mapfastej()
...
-   shape... and shapefile\_... state_from\_... and state... usastats...

-   lookup_pctile(), pctile_from_raw_lookup()

-   table_gt\_... and table\_... url\_... var... like varinfo()

DATA names\_... see ?dataload_from_pins() usastats, statestats
...
## Specify a List of Points such as Facilities
...
# Detailed views, diagnostics, granular results
...
### Site vary widely in count of blocks nearby, depending on population density
