...
# 
library(EJAM)
 dataload_from_pins('all'); dataload_from_pins("blockid2fips")
 indexblocks()
...
#
#    -  rmarkdown::render("vignettes/EJAM-vignette.Rmd", encoding = 'UTF-8') 
...
#### Site vary widely in \# of blocks nearby, depending on population density
