...
The R package is still in active development, but a current version can be installed from the github USEPA github repository. You can install the development version of EJAM like so:
...
## Get Help / See Documentation on all the Functions and Data
