...
x <- ejamit(testpoints_n(100))
mapfast(x$results_bysite)

```

Use interactive file picker without full shiny web app
...
-   **ejamit()** provides results in just one function.
...
# EJ pctiles, statename,  REGION, etc. not yet in EJAM output.
