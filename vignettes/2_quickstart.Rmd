...
## or just open that folder like this: 
...
## Map your sites before or after analyzing them
...
# output, results of EJAM
mapfastej(testoutput_ejamit_100pts_1miles$results_bysite) 
```
...
mapfast(testpoints_n(300, ST_needed = c('LA','TX'), weighting = 'bg'), radius = 0.1) 
