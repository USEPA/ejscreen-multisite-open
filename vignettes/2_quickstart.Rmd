...
# Intro to EJAM Analysis in R

After EJAM has been installed, here's how you can run an EJAM analysis and view results right away:
...
## Analyze a List of Places: ejamit()
...
![Summary table of environmental and demographic indicators as raw value, average and percentile (in State and in US overall)](images/image-report_top_example.png)

![Summary table of EJ Indexes, race-ethnicity subgroups, gender, and language indicators](images/image-report_EJ_table_example.png)
![US map showing analyzed points](images/image-map_example.png)

![Barplot comparing demographic indicators as ratios to US average](images/image-barplot_example.png)
...
```{r plot_barplot_ratios, echo=FALSE}
## Plot of demographics is default
out <- testoutput_ejamit_100pts_1miles
...
## Forthcoming version syntax is simpler! 
## it will accept ejamit() output directly, as its input.
```

## Spreadsheet: ejam2excel()
...
![Excel output showing 1 row per site and 1 column per indicator such as total population nearby](images/image-xlsx.png)
...
```{r ejam2report2, include=FALSE, eval=FALSE}
out <- testoutput_ejamit_100pts_1miles
x <- ejam2report(out)
...
-   See the [README on GitHub](https://github.com/USEPA/EJAM/tree/gh-pages?tab=readme-ov-file#readme)
