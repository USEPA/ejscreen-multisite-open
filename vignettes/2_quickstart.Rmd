...
# EJAM Analysis in R - Quick Start Guide

Here's how you can run an EJAM analysis and view results right away (once EJAM has been set up)

## Install EJAM

See the separate vignette on how to install the R package from https://github.com/USEPA/EJAM 
...
# Click a point on the map to see a popup with details about people near that point.
```

##  Report (interactive html file)
...
## Updated version of this function will be able to handle output of ejamit() as input:
# out <- testoutput_ejamit_100pts_1miles
# plot_barplot_ratios(out)
#plot_barplot_ratios(out, reference = "State")
...
# More Examples of Using these Functions in EJAM
...
```{r ejamit_testpoints_100, eval=TRUE, message=FALSE, warning=FALSE}
...
```{r map, eval = TRUE, echo= TRUE, fig.height=8, fig.width=6}
out <- testoutput_ejamit_100pts_1miles
mapfastej(out$results_bysite)
# help("mapfast")
```
...
-   A pdf version of documentation will be provided, possibly here: <https://github.com/USEPA/EJAM/tree/main/www>

-   An HTML version of documentation will be provided, possibly here: <https://github.com/USEPA/EJAM/tree/main/www>
