...
golem::add_module(name = "view_results", with_test = TRUE) # Name of the module
golem::add_module(name = "save_report", with_test = TRUE) # Name of the module
...
# usethis::use_github_action_check_release()   #same as  use_github_actions()
