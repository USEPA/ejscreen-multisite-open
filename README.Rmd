...
-   EJAM is EJScreen's tool for providing multisite reports. It can be reached from the [EJScreen website](https://www.epa.gov/ejscreen) and [EJScreen Mapping application](https://ejscreen.epa.gov/mapper/).
