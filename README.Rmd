...
EJScreen will be able to leverage EJAM's technology to provide public access to batches of reports. EJAM itself is not an app running on a public website. A user-friendly interface will be made available to the public in the future, as part of EJScreen (based on EJAM code). EJAM was being tested for internal use at EPA as of early 2024.
