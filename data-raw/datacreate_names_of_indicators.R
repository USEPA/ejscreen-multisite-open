...
datacreate_names_of_indicators <- function() {
  ...
  # An approach to create all the lists of variable names and save them to the package as lazyloaded datasets
...
"
  ...
  # check if usastats and statestats colnames are the same as names_these
  ...
  # older code creating _friendly versions of names
