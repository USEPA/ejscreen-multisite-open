...
fname <- "https://www2.census.gov/geo/docs/reference/cenpop2020/blkgrp/CenPop2020_Mean_BG.txt"
...
x$ST = stateinfo$ST[match(x$FIPS.ST, stateinfo$FIPS.ST)]
...
bg_cenpop2020$bgid <- bgid2fips[bg_cenpop2020,  bgid, on = "bgfips"]
  setkey(bg_cenpop2020, bgid, bgfips)
...
# [1] 334,735,155
# > sum(blockgroupstats$pop)
# [1] 329,824,950
# mapfast(bg_cenpop2020[ST=="LA",], radius = 0.01)

bg_cenpop2020 <- metadata_add(bg_cenpop2020, metadata = list(download_date=Sys.time(), source=fname)) 
