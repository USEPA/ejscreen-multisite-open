    ...
    fluidPage(
      ...
      tabsetPanel(
        ...
        tabPanel(title = 'Site Selection',
           ...
           #h3('Welcome to EJAM'),
           span('EPA has developed a new environmental justice (EJ) mapping and screening tool called the Environmental Justice Analysis Multi-site Tool (EJAM). Similar to the EJ review tool, EJScreen, EJAM sources and combines consistent data and environmental and demographic indicators in maps and reports. The goal for EJAM is to allow its audience to access high-resolution environmental and demographic information for locations all throughout the United States, and compare multiple selected locations to the rest of the state, EPA region, or nation in batched reports. You can learn more about EJAM through the ',
