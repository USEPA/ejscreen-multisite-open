...
- R users vignettes that will walk through installation and key
  functions: See `vignette(package="EJAM")` or (must be on VPN)

  - [0. Using EJAM as a Web App](0_webapp.html "0_webapp.html")

  - [1. Installing the EJAM
    package](1_installing.html "1_installing.html")

  - [2. Quick Start Guide](2_quickstart.html "2_quickstart.html")

  - [3. Basics of Using EJAM for Analysis in
    RStudio](3_analyzing.html "3_analyzing.html")

  - [4. Advanced Features](4_advanced.html "4_advanced.html")

  - [5. Using the EJScreen API via
    EJAM](5_ejscreenapi.html "5_ejscreenapi.html")
...
- EJAM Web App beta internal to EPA: As of 1/2024 the main app is on a
  staging server for beta testing:

  - [EJAM beta test
    version](https://rstudio-connect.dmap-stage.aws.epa.gov/content/cb2bc9cf-75c3-4db1-ad28-e92940fe4438/ "https://rstudio-connect.dmap-stage.aws.epa.gov/content/cb2bc9cf-75c3-4db1-ad28-e92940fe4438/")\*\*
    (must be on VPN)
