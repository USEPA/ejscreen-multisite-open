...
Residents within `r params$distance` of any of the `r params$n_sites` sites analyzed\
\
...
```{r, out.width ='900px'}
 # dt <- cbind('Value at Uploaded Sites' = as.list( 100*round(params$cur_data$results_overall[ , ..names_d], 2)),
 #          'State Percentile' = as.list(round(params$cur_data$results_overall[, ..names_d_state_pctile], 2)),
 #          'National Percentile' = as.list(round(params$cur_data$results_overall[, ..names_d_pctile], 2)))
 #    
...
#                   as.list(round(params$cur_data$results_overall[ , ..names_e],2)),
#           'State Percentile' = as.list(round(params$cur_data$results_overall[, ..names_e_state_pctile],2)),
#           'Percentile in USA' = as.list(round(params$cur_data$results_overall[, ..names_e_pctile],2)))
#     
