...
#    
#  rownames(dt) <- names_d_friendly # different sort order than # names_d_friendly[pmatch(names_d,  names_d_batch)]  # EJAMbatch.summarizer pkg
...
```{r summary_plot, out.width = '1000px', out.height = '500px', fig.align='center'}
