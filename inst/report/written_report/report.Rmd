...
tool](https://usepa.github.io/EJAM/index.html "Environmental Justice Analysis Multisite (EJAM) tool")
...
[EJScreen](https://epa.gov/ejscreen "EPA EJScreen homepage"){.uri target="_blank" rel="noreferrer noopener"} and with
more technical details available at [EJScreen technical documentation
page](https://www.epa.gov/ejscreen/technical-information-about-ejscreen "EPA EJScreen technical information"){.uri target="_blank" rel="noreferrer noopener"}.
...
The demographics included here are those in EJScreen and
