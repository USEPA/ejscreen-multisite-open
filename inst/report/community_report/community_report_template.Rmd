...
HTML('<div style="background-color: #edeff0; color: black; width: 100%; padding: 10px 20px; text-align: right; margin: 10px 0;">
                   <p style="margin-bottom: 0;">Version 2.2 | Report created on ', current_date, '</p>
                 </div>')
```
