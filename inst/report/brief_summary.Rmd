...
EJAM Report (EJScreen v2.2 8/2023)
:::
...
#    
#  rownames(dt) <- names_d_friendly # different sort order than # names_d_friendly[pmatch(names_d, names_d_batch)] # EJAMbatch.summarizer package
